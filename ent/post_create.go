...
func (pc *PostCreate) SetPosterID(id uint64) *PostCreate {
...
func (pc *PostCreate) check() error {
	...
	if _, ok := pc.mutation.PosterID(); !ok {
		return &ValidationError{Name: "poster", err: errors.New(`ent: missing required edge "Post.poster"`)}
	}
	return nil
}
